		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">El <span>Sanchel</span><p class="logo_w3l_agile_caption">AZURE URBAN RESORT RESIDENCES</p></a></h1>
				</div>
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>EL SANCHEL</h4>
									<h3>LEGIT STAYCATION OWNER (❌not an Agent)</h3>
										<p>with Guest Reviews, willing for LEGIT CHECK</p>
